...
def readExcelIntoDb(excel_file_path) :
    ...
    try : 
        ...
        substring_to_find_capitaline_screener = 'Capitaline Screener >> Standalone >> \(Rs In Crores\s*\)'
        substring_to_find_disclaimer = 'Disclaimer: Capitaline Database has taken due care and caution'


        # Load the Excel sheet
        # Downloaded_File_Path = r"C:\Users\stagadmin\CAPITALINE\standaloneCapitaline\downloadExcel\Download_standalone_20231222.xlsx"
        ...
        scraped_length = 0
        update_length = 0
        # subtitle_index = 0 disclaimer_index=180
